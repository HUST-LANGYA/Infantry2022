...
//将要输出的变量声明extern
extern FuzzyPID FuzzyPidPitchPos,FuzzyAidPidPitchPos,FuzzyAidPidYawPos;
extern Pid_Typedef PidPitchAidSpeed,PidYawAidSpeed;
extern Pid_Typedef PidBodanMotorPos,PidBodanMotorSpeed;
extern short BodanMotorCurrent;
extern FuzzyPID FuzzyBodanMotorPos;
extern Gyro_Typedef GyroReceive;//陀螺仪数据
extern int gyro_receive;
